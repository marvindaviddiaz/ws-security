 ...
 *         &lt;element name="autorizacionFacturador" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
public class PayBillResponse {
    ...
    /**
     * Obtiene el valor de la propiedad autorizacionFacturador.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Define el valor de la propiedad autorizacionFacturador.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAutorizacionFacturador(String value) {
        this.autorizacionFacturador = value;
    }
